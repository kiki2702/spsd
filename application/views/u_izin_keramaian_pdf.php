...
p.isi{
    ...
    <title>SURAT PERNYATAAN IZIN KERAMAIAN</title>
    <style type="text/css">
    	tr, th{
...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT PERNYATAAN IZIN KERAMAIAN</h3>
	...
	<p>Akan mengadakan acara tersebut yang akan dilaksanakan pada :</p>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<br>
		<p>Demikian Surat izin keramaian ini kami buat, atas perhatiannya kami ucapkan terima kasih.</p>
		<br>
		<br>
		<br>
