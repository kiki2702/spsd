...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN USAHA</h3>
	<P style=" margin-top: 0">Nomor : .... / ... / ... .... .... .... / .....</P>

	<div class="paragraf" style="margin-top:5mm;margin-left: 10mm;margin-right: 10mm">
	<p class="indent">Kami yang bertanda tangan dibawah ini, Kepala Desa Sentol Kecamatan Pademawu Kabupaten Pamekasan, menerangkan bahwa :</p>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<tr class="surat">
			<td class="surat">Pekerjaan/Usaha</td>
		...
		<p>Orang tersebut diatas benar – benar mempunyai usaha : <?php echo $usaha ?></p>
		
		<table class="surat" style="margin-left: 20px">
		<tr class="surat">
			<td class="surat">Tujuan</td>
			<td class="surat">: <?php echo $tujuan ?></td>
		</tr>
		</table>
		
		<br>
		<p class="indent">Demikian keterangan ini digunakan untuk perlengkapan administrasi dan kepada yang bersangkutan agar dapat dipergunakan sebagaimana mestinya.</p>
		<br>
		<br>
		<br>
