...
p.isi{
    ...
    <title>SURAT KETERANGAN IDENTITAS</title>
    <style type="text/css">
    	tr, th{
...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN IDENTITAS</h3>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<br>
		<p class="indent">Adalah benar-benar penduduk Desa Sentol Kecamatan Pademawu Kabupaten Pamekasan dan ……………………………………………………………………………………………</p>
		<p class="indent">Demikian Surat keterangan ini kami buat dengan sebenarnya agar dapat dipergunakaan sebagaimana mestinya.</p>
		<br>
		<br>
		<br>
