<main role="main" class="container">
      <h1 class="mt-4">Surat Keterangan Identitas</h1>
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <form action="<?php echo base_url(); ?>page/ket_identitas_pdf" method="post">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control form-control-sm" id="nama" name="pekerjaan" placeholder="Pekerjaan" required>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Berlaku</label>
    <div class="col-sm-9">
      <input type="text" class="form-control form-control-sm" id="agama" name="berlaku" placeholder="Berlaku" required>
    </div>
  </div>
  <!-- <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Keterangan</label>
    <div class="col-sm-9">
      <input type="text" class="form-control form-control-sm" id="agama" name="keterangan" placeholder="Keterangan" required>
    </div>
  </div> -->
  <div class="form-group row">
