...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN</h3>
	<P style=" margin-top: 0">Nomor : .... / ... / ... .... .... .... / .....</P>

	<div class="paragraf" style="margin-top:5mm;margin-left: 10mm;margin-right: 10mm">
	<p class="indent">Dengan ini kami menerangkan dengan sebenarnya:</p>
	<table class="surat" style="margin-left: 20px">
		...
		<tr class="surat">
			...
			<td class="surat">: <?php echo $tempat_tujuan ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Keterangan Lain</td>
			<td class="surat">: <?php echo $keterangan ?></td>
		</tr>
		</table>
		
		<br>
		<p class="indent">Demikian Keterangan ini kami buat dengan benar dan kami berikan kepada yang bersangkutan untuk digunakan seperlunya. Kemudian kepada yang berkepentingan menjadikan periksa.</p>
		<br>
		<br>
		<br>
