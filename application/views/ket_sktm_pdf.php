...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN TIDAK MAMPU</h3>
	<P style=" margin-top: 0">Nomor : .... / ... / ... .... .... .... / .....</P>

	<div class="paragraf" style="margin-top:5mm;margin-left: 10mm;margin-right: 10mm">
	<p class="indent">Yang bertanda tangan dibawah ini, Kepala Desa Sentol Kecamatan Pademawu Kabupaten Pamekasan, Menerangkan dengan sebenarnya bahwa:</p>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<br>
		<p class="indent">Adalah benar-benar penduduk Desa Sentol Kecamatan Pademawu Kabupaten Pamekasan. Setelah diadakan penelitian ternyata keluarga tersebut tergolong tidak mampu (Keluarga Miskin). Dengan pertimbangan tersebut kami mengajukan permohonan untuk mendapatkan <?php echo $keterangan ?> bagi putra/putrinya:</p>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<tr class="surat">
			<td class="surat">Jenis Kelamin</td>
			<td class="surat">: <?php echo $jenis_kelamin_anak ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Agama</td>
		...
		<tr class="surat">
			<td class="surat">Kelas</td>
			<td class="surat">: <?php echo $kelas_anak ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Sekolah</td>
			<td class="surat">: <?php echo $sekolah_anak ?></td>
		</tr>
		</table>

		<p class="indent">Demikian Surat keterangan tidak mampu ini kami buat dengan sebenarnya agar dapat dipergunakaan sebagaimana mestinya.</p>
		<br>
		<br>
		<br>
