...
p.isi{
    ...
    <title>SURAT PERNYATAAN KARTU KELUARGA</title>
    <style type="text/css">
    	tr, th{
...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT PERNYATAAN KARTU KELUARGA</h3>
	...
	<table class="surat" style="margin-left: 20px">
		<tr class="surat">
			<td class="surat" width="150px"><b>Di Kartu Keluarga</b></td>
		</tr>	
		<tr class="surat">
		...
		<tr class="surat">
			<td class="surat">Warga Negara</td>
	...
	<p>Nama orang di atas adalah salah, adapun  yang benar sesuai dengan yang ada  Kutipan Akta Kelahiaran  adalah :</p>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<tr class="surat">
			<td class="surat">Tempat, Tanggal lahir</td>
			<td class="surat">: <?php echo $ttl_kedua ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Jenis Kelamin</td>
			<td class="surat">: <?php echo $jenis_kelamin_kedua ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Warga Negara</td>
			<td class="surat">: <?php echo $kebangsaan_kedua ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Agama</td>
			<td class="surat">: <?php echo $agama_kedua ?></td>
		</tr>
	</table>
		
		<br>
		<p>Demikian surat pernyataan ini dibuat untuk dipergunakan mengurus kartu Keluarga.</p>
		<br>
		<br>
		<br>
