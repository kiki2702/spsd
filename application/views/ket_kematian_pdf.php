...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN KEMATIAN</h3>
	...
	<table class="surat" style="margin-left: 20px">
		<tr class="surat">
			<td class="surat" width="150px">Hari </td>
		...
		<tr class="surat">
			...
			<tr class="surat">
			<td class="surat">Bertempat di</td>
			<td class="surat">: <?php echo $bertempat ?></td>
		</tr>
		</table>

		<p class="indent">Surat keterangan ini di buat berdasarkan keterangan pelapor :</p>

	<table class="surat" style="margin-left: 20px">
		<tr class="surat">
			<td class="surat" width="150px">Nama Lengkap </td>
			<td class="surat">: <?php echo $nama_pelapor ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">NIK</td>
			<td class="surat">: <?php echo $nik_pelapor ?></td>
		</tr>
			<tr class="surat">
			<td class="surat">Umur</td>
			<td class="surat">: <?php echo $umur_pelapor ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Pekerjaan</td>
			<td class="surat">: <?php echo $pekerjaan_pelapor ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Alamat</td>
			<td class="surat">: <?php echo $alamat_pelapor ?></td>
		</tr>
		</table>
		
		<br>
		<p class="indent">Hubungan pelapor dengan yang meninggal : <?php echo $hub_pelapor ?></p>
		<br>
		<br>
		<br>
