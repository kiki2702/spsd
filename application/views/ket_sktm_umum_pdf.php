...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<table class="surat" style="margin-left: 20px">
		...
		<br>
		<p class="indent">Adalah benar-benar penduduk Desa Sentol Kecamatan Pademawu Kabupaten Pamekasan. Setelah diadakan penelitian ternyata keluarga tersebut tergolong tidak mampu (Keluarga Miskin). Dengan pertimbangan tersebut kami mengajukan permohonan untuk mendapatkan <?php echo $keterangan ?></p>
