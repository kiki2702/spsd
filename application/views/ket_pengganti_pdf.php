...
p.isi{
    ...
    <title>SURAT KETERANGAN PENGGANTI KTP</title>
    <style type="text/css">
    	tr, th{
...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN PENGGANTI KTP</h3>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<tr class="surat">
			...
			<td class="surat">: EKA HENDRA PRASETYO, S.H</td>
		</tr>
		<tr class="surat">
	...
	<table class="surat" style="margin-left: 20px">
		...
		<br>		
		<p class="indent">Demikian surat keterangan ini kami buat dengan sebenarnya dan kami berikan kepada yang bersangkutan untuk dipergunakan seperlunya.</p>
		<br>
		<br>
		<br>
		...
		echo "<table class='surat' style='margin-left: 30px'>
			<tr>
				<td class='surat'>Mengetahui<br>Camat Pademawu<br><br><br><br><br><br>_________________<br>NIP.</td>
