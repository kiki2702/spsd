<main role="main" class="container">
      <h1 class="mt-4">Surat Keterangan Tidak Mampu (Sekolah)</h1>
  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <form action="<?php echo base_url(); ?>page/ket_sktm_pdf" method="post">
  <p>DATA ORANG TUA</p>
  ...
  <div class="form-group row">
    <label for="exampleFormControlSelect1" class="col-sm-3 col-form-label col-form-label-sm">Jenis Kelamin</label>
    <div class="col-sm-9">
    <select class="form-control form-control-sm" id="jenis_kelamin" name="jenis_kelamin_anak" required>
    <option>Pilih Jenis Kelamin...</option>  
    <option>Laki-laki</option>
    <option>Perempuan</option>
    </select>
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Kelas</label>
    <div class="col-sm-9">
      <input type="text" class="form-control form-control-sm" id="nama" name="kelas_anak" placeholder="Kelas" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label col-form-label-sm">Sekolah</label>
    <div class="col-sm-9">
      <input type="text" class="form-control form-control-sm" id="agama" name="sekolah_anak" placeholder="Sekolah" required>
    </div>
  </div>
  <div class="form-group row">
