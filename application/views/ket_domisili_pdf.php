...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN DOMISILI</h3>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<br>
		<p class="indent">Bahwa nama tersebut diatas benar – benar berada/berdomisili di Desa/Kelurahan seperti terebut di atas.</p>
		<p class="indent">Demikian Surat keterangan domisili ini kami buat dengan sebenarnya agar dapat dipergunakaan sebagaimana mestinya.</p>
		<br>
		<br>
		<br>
