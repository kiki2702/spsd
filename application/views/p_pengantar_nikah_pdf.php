...
p.isi{
    ...
    <title>SURAT KETERANGAN PENGANTAR NIKAH</title>
    <style type="text/css">
    	tr, th{
...
<img src="<?php echo base_url()?>assets/img/header.png" width=92%  ></div>	
	...
	<h3 style="text-decoration: underline; margin-bottom: 0;margin-top: 5mm">SURAT KETERANGAN PENGANTAR NIKAH</h3>
	<P style=" margin-top: 0">Nomor : .... / ... / ... .... .... .... / .....</P>

	<div class="paragraf" style="margin-top:5mm;margin-left: 10mm;margin-right: 10mm">
	<p class="indent">Dengan ini menerangkan dengan sebenarnya bahwa :</p>
	...
	<table class="surat" style="margin-left: 20px">
		...
		<tr class="surat">
			...
			<td class="surat">: <?php echo $status_nikah ?></td>
		</tr>
		<tr class="surat">
		...
		<tr class="surat">
			<td class="surat">Tempat Tujuan</td>
			<td class="surat">: <?php echo $tujuan ?></td>
		</tr>
		<tr class="surat">
		...
		<br>
		<tr class="surat">
			<td class="surat">Berlaku</td>
			<td class="surat">: <?php echo $berlaku ?></td>
		</tr>
		<tr class="surat">
			<td class="surat">Keterangan Lain</td>
			<td class="surat">: <?php echo $ket_lain ?></td>
		</tr>

	</table>

		<p class="indent">Demikian surat keterangan ini kami buat dengan sebenarnya dan kami berikan kepada yang bersangkutan untuk digunakan seperlunya dan kepada yang berkepentingan untuk menjadikan periksa.</p>
		<br>
		<br>
		<br>
